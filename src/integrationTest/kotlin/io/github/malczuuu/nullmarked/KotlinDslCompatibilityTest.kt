...
/**
 * Runs the core plugin scenario, from a Kotlin `build.gradle.kts`, against the Gradle version given by the
 ...
 * suite. Mirrors [GroovyDslCompatibilityTest] test-for-test, one per DSL.
 */
