 ...
 * @param packageSelectionRules ordered package rules, as encoded by [PackageRule.encode]
 ...
 * according to [packageSelectionRules]. Used both to decide what to generate and to decide what verification is
 * missing; which of the two it answers depends only on whether the caller passes the generated output directory in
 * [sourceDirectories].
 *
