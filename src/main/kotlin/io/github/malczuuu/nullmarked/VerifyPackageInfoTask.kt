 ...
 * is not excluded by [packageSelectionRules]. When [verificationEnabled] is `false`, the task passes without checking
 * anything.
 *
...
abstract class VerifyPackageInfoTask : DefaultTask() {
   ...
   * [GeneratePackageInfoTask.packageSelectionRules]. Configure them through the `nullmarked { packages { ... } }`
   * block, see [NullMarkedPackagesSpec].
   */
