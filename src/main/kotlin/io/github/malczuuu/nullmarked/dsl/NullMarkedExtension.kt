...
public abstract class NullMarkedExtension @Inject constructor(objects: ObjectFactory) {
  ...
  public abstract val headerEnabled: Property<Boolean>
   ...
   */
  public abstract val verifyOnly: Property<Boolean>
   ...
   */
  public abstract val jspecifyVersion: Property<String>
   ...
   */
  public fun sourceSet(name: String) {
   ...
   */
  public fun sourceSet(name: String, configuration: Action<in NullMarkedSourceSetSpec>) {
