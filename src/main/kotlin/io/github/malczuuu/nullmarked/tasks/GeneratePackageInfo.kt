 ...
 */
@CacheableTask
public abstract class GeneratePackageInfo @Inject constructor(objects: ObjectFactory) : DefaultTask() {
  ...
  @get:Input public abstract val generationEnabled: Property<Boolean>

  /** Whether the generated files start with a `Generated by ...` comment. */
  @get:Input public abstract val headerEnabled: Property<Boolean>
